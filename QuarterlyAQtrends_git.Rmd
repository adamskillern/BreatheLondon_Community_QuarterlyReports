...
q3_start <- report_dates$q3_start
q3_end <- report_dates$q3_end
q4_start <- report_dates$q4_start
q4_end <- report_dates$q4_end
report_year <- report_dates$report_year

current_quarter <- (lubridate::month(Sys.Date()) - 1L) %/% 3L + 1L
quarter_headings <- c(
...
quarter_heading <- paste(quarter_headings[current_quarter], "in", report_year)
...
NO2_weekdays_Q3 <- NO2_weekdays %>% filter(between(Date2, q3_start, q3_end)) 
NO2_weekdays_Q4 <- NO2_weekdays %>% filter(between(Date2, q4_start, q4_end))
...
PM2.5_weekdays_Q3 <- PM2.5_weekdays %>% filter(between(Date2, q3_start, q3_end)) 
PM2.5_weekdays_Q4 <- PM2.5_weekdays %>% filter(between(Date2, q4_start, q4_end))
...
NO2_weekends_Q3 <- NO2_weekends %>% filter(between(Date2, q3_start, q3_end)) 
NO2_weekends_Q4 <- NO2_weekends %>% filter(between(Date2, q4_start, q4_end))
...
PM2.5_weekends_Q3 <- PM2.5_weekends %>% filter(between(Date2, q3_start, q3_end)) 
PM2.5_weekends_Q4 <- PM2.5_weekends %>% filter(between(Date2, q4_start, q4_end))
